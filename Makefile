...
start:
	...
	$(DOCKER_COMPOSE_CMD) $(DOCKER_COMPOSE_ENV) -f ./docker-compose-lokitempo.yml up --force-recreate --remove-orphans --detach
	@echo ""
...
stop:
	...
	$(DOCKER_COMPOSE_CMD) $(DOCKER_COMPOSE_ENV) -f docker-compose-lokitempo.yml down --remove-orphans --volumes
	@echo ""
